...
# Use opengradient version pip install opengradient==0.5.0a1
...
result = client.llm_chat(model_cid="gemini-2.5-flash-lite", inference_mode=LlmInferenceMode.VANILLA, messages=messages)
print(f"Response: {completion.chat_output['content']}")
print(f"Tx hash: {completion.transaction_hash}")
